...
void man(char* name)
{
    ...
    {
        printf("Decription : used to create new reguar file\n");
    ...
    {
        printf("Desrciption : used to list all information \n");
    ...
    else if(strcmp(name,"lseek")==0)
    {
        ...
        printf("Usage : Lseek File_Name ChangrInOffest StartPoint\n");
    }
    else if(strcmp(name, "rm")==0)
    {
         printf("Description : Used to delete file offset\n");
